...
AbstractClass.hasAndBelongsToMany = function (anotherClass, params, describe) {
    var relation = params.through,
    utils = railway.utils,
    ...
    fk2 = utils.camelize(this.modelName + '_id');
     ...
     var Rel = describe( relation, function () { });
     Rel.belongsTo(this.modelName, {as: accessorName1, foreignKey: fk1});
     Rel.belongsTo(anotherClass.modelName, {as: accessorName2, foreignKey: fk2});
